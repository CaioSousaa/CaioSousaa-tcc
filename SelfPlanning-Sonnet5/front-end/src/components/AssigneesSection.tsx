      ...
      <div className="flex flex-wrap items-center gap-2">
        {assignees.map((assignee) => (
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-700 text-xs font-semibold text-white hover:bg-red-600"
          >
            ...
            <div className="absolute left-0 top-9 z-10 w-48 rounded-md border border-zinc-200 bg-white p-1 shadow-lg">
              {availableMembers.length === 0 ? (
                ...
                availableMembers.map((member) => (
                  ...
                  >
                    <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-700 text-[10px] font-semibold text-white">
