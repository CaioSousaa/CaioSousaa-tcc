...
3 - Role do agente: implementar o que foi solicitado. Pode executar tsc e npm run build para verificar erros de importação ou dependências faltantes — pode corrigir só esses tipos de erro. Não execute testes da aplicação.
